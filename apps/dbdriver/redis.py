...
"""
import redis
from aioredis import Connection, BlockingConnectionPool, Redis, from_url
...
class AioRedis:
    ...
    async def redis_connect_pool(self):
        """创建连接池"""
        logger.info(f"连接Redis: {self.connect_config}")
...
class RedisConnection:
    ...
    def redis_connect_pool(self):
        logger.info(f"连接Sync_Redis: {self.connect_config}")
