...
from apps.baseserver.dbinterface import DBConnectionFactory
from apps.utils.time_handler import time_remaining
import re
...
class MysqlBaseService(object):
    ...
    async def execute(self, sql: str = None, data: Union[dict, list] = None, table_name: str = None,  t_index: str = None):
        t_index = t_index if t_index else self.t_index
